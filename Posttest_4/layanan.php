...
<body>
    ...
    <form id="form-daftar" action="proses.php" method="POST" enctype="multipart/form-data">
        <table>
            <tr>
                <td><label for="kegiatan">Pilih Layanan *</label></td>
                <td><select id="kegiatan" name="kegiatan" >
            ...
            <tr>
                ...
                <td><input type="text" id="tempat" name="tempat" ></td>
            </tr>
            <tr>
                <td><label for="tangla">Tanggal Lahir *</label></td>
                <td><input type="date" id="tangla" name="tangla" ></td>
            </tr>
            <tr>
                <td><label for="alamat">Alamat Sesuai KTP *</label></td>
                <td><textarea name="alamat" id="alamat" rows="4" cols="40" ></textarea></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="number" id="rw" name="rw" ></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="pekerjaan" name="pekerjaan" ></td>
            </tr>
            <tr>
                <td><label for="f-ktp">File KTP *</label></td>
                <td><input type="file" name="f-ktp" id="f-ktp" ></td>
            </tr>
            <tr>
                <td><p class="ket-wajib" style="font-size: 15px;">* Wajib di isi</p></td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <div id="notif-sukses" style="display: none; color: green; font-weight: bold;">Formulir berhasil diisi!</div>
                </td>
            </tr>
        </table>
    </form>
